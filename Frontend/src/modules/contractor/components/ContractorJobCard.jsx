...
const ContractorJobCard = memo(({ job, onViewDetails, onApplyNow, appliedJobs = {}, index = 0 }) => {
    ...
    const handleChatClick = async () => {
        ...
        try {
            ...
            if (chatId) {
                console.log('✅ ChatId available in application data, navigating to:', `/contractor/chat/${chatId}`);
            ...
            if (response.success && response.data.applications) {
                ...
                if (updatedApplication?.chatId) {
                    console.log('✅ ChatId found in updated application, navigating to:', `/contractor/chat/${updatedApplication.chatId}`);
                    navigate(`/contractor/chat/${updatedApplication.chatId}`);
                    return;
                }
            }
