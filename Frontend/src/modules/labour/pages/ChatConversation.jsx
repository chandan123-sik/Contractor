                ...
                <div className="relative">
                    ...
                    {showMenu && (
                        <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 py-2 z-20">
                            ...
                            <button onClick={() => { if (window.confirm(`Block ${contact.name}?`)) { setShowMenu(false); navigate('/labour/chat'); }}} className="w-full px-4 py-2 text-left hover:bg-red-50 flex items-center gap-3 text-red-600">
