...
const WorkerRequestCard = ({ request, onAccept, onDecline, index = 0, showButtons = true, showStatus = false }) => {
    return (
        <div className="premium-card card-fade-in" style={{ animationDelay: `${index * 0.05}s` }}>
            ...
            <div className="flex items-center gap-3 mb-4">
                ...
                <div className="flex-1">
                    <h3 className="font-bold text-gray-900 text-lg">{request.workerName}</h3>
