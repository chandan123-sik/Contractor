...
const Notifications = () => {
    ...
    const fetchNotifications = async () => {
        try {
            ...
            const response = await fetch('http://localhost:5000/api/notifications?userType=USER', {
                headers: {
    ...
    const deleteNotification = async (id) => {
        try {
            ...
            const response = await fetch(`http://localhost:5000/api/notifications/${id}?userType=USER`, {
                method: 'DELETE',
                headers: {
                    'Authorization': `Bearer ${token}`
                }
    ...
    return (
        <div className="min-h-screen bg-gray-50 pb-20">
            <PageHeader title="Notifications" backPath="/user/home" />
                        ...
                        {notifications.map((notification) => (
                            <div
                                ...
                                className={`bg-white rounded-lg shadow-sm border-l-4 ${
                                    notification.isRead ? 'border-gray-300' : 'border-yellow-400'
                                } overflow-hidden`}
                            >
                                <div className="p-4">
